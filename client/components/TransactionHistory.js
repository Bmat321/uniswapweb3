...
const style = {
    wrapper: `h-full text-white select-none w-screen flex-1 pt-10 flex items-end justify-end pb-4 overflow-scroll px-8`,
    txHistoryItem: `bg-[#191a1e] rounded-lg px-2 py-2 my-1  flex items-center justify-end`,
